...
| pruning N/PD training subjects by measured INFLUENCE (Data-Shapley style) | no better than random and trends worse — influence-vs-random precET −0.045 [−0.108, +0.005] (`influence_prune.md`). The ranking is unstable: the most-dropped subject recurs in only 8 of 20 splits |
