...
`reports/` holds ~85 findings; `reports/failed_predictions.md` is the register of
predictions made before the run (25 failed, 17 held); `experiments/INDEX.md` maps
...
9. **Record the prediction in the docstring before launching**, then append the
   ...
   have held here (seventeen of seventeen); mechanism stories have failed 25 times.
