...
`reports/` holds ~86 findings; `reports/failed_predictions.md` is the register of
predictions made before the run (26 failed, 18 held); `experiments/INDEX.md` maps
...
9. **Record the prediction in the docstring before launching**, then append the
   ...
   have held here (eighteen of eighteen); mechanism stories have failed 26 times.
